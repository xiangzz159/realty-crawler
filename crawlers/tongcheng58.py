...
class tongcheng58(RealEstate):
    ...
    def get_city_all_infos(self, city):
    ...
    def get_info(self, link):
        try:
            ...
            total_price = self.get_page_show_ret(basic_item1[0].text.strip(), bs64_str)
            price_per = self.get_page_show_ret(basic_item1[1].text.strip(), bs64_str)
    ...
    def get_page_show_ret(self, string, bs64_str):
